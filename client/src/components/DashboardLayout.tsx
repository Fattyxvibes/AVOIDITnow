...
export default function DashboardLayout({
  ...
  return (
    ...
    >
      <DashboardLayoutContent setSidebarWidth={setSidebarWidth} menuItems={menuItems} label={label}>
        {children}
        ...
        >
          ...
          <SidebarFooter className="p-3">
            <div className="space-y-2 group-data-[collapsible=icon]:space-y-1">
              ...
              <Button variant="ghost" size="sm" onClick={logout} className="w-full justify-start text-destructive hover:bg-destructive/10 hover:text-destructive group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0" aria-label="Sign out">
